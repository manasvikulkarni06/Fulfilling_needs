        ...
        <section class="signup">
            <div class="container">
                <div class="signup-content">
                    <form action="UserRegister" method="POST" id="signup-form" class="signup-form">
                        <h2 class="form-title">REGISTER HERE/LOGIN</h2>
                        <div class="form-group">
                            <input type="text" class="form-input" name="name" id="name" placeholder="Your Name" required/>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="userid" id="userid" placeholder="Your User Id" required/>
                        </div>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                             <input type="text" class="form-input" name="contact_no" id="contact_no" placeholder="Your Contact No" required/>
                        </div>
