...
<body class="animsition">
		...
		<div class="container-menu-header-v2 p-t-26">
			<div class="topbar2">
				...
				<a href="welcome_user.jsp">
                                    <font size="10" color="brown"><b><u>  FULFILLING_NEEDS</u></b></font>
				</a>
				...
				<div class="item-slick1 item1-slick1" style="background-image: url(images/pic1.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						...
						<div class="wrap-btn-slide1 w-size1 animated visible-false" data-appear="zoomIn">
							<!-- Button -->
							<a href="user_register.jsp" class="flex-c-m size2 bo-rad-23 s-text2 bgwhite hov1 trans-0-4">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="user_register.jsp" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                                            <b>Furniture</b>
							</a>
						</div>
					</div>
 ...
 <font size="5" >Copyright © 2019 All rights reserved.<br>By-<br></font>
              <font size="3" >Manasvi Kulkarni<br></font>
            <font size="3" >Gagan Patankar<br></font>
	</footer>
